...
namespace DevFreela.Infra.Persistence.Migrations
{
    ...
    [Migration("20230607113540_Initial")]
            ...
            modelBuilder.Entity("DevFreela.Core.Entities.Project", b =>
                {
                    ...
                    b.HasIndex("IdFreenlancer");

                    b.ToTable("Projects");
                });

            modelBuilder.Entity("DevFreela.Core.Entities.ProjectsComments", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DevFreela.Core.Entities.Project", b =>
                {
                    ...
                    b.HasOne("DevFreela.Core.Entities.User", "Freelance")
                        .WithMany("FreelanceProjects")
                        .HasForeignKey("IdFreenlancer")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
